...
class Plane {
  ...
  raycast(ray) {
    ...
    console.log(`numerator: ${numerator}, denominator: ${denominator}, alpha: ${alpha}`);
    console.log(`ray origin: ${ray.origin}, ray direction: ${ray.direction}, plane normal: ${this.normal}, plane valid point: ${this.validPoint}`);
    console.log(`dot product of plane normal and ray direction: ${this.normal.dot(ray.direction)}`);
