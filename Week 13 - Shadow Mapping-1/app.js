...
function createShaders() {
    ...
    phongShaderProgram.uniforms = {
        ...
        shadowTexelSizeUniform: gl.getUniformLocation(phongShaderProgram, "uShadowTexelSize")
    };
}
...
function updateAndRender() {
    ...
    gl.uniform2f(uniforms.shadowTexelSizeUniform, 1.0 / fbo.width, 1.0 / fbo.height);
